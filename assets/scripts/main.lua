...
--
local transform = playerEntity:add_component(TransformComponent(100, 100, 3, 3, 0))
...
local transform2 = mashaEntity:add_component(TransformComponent(300, 300, 0.1, 0.1, 0))
