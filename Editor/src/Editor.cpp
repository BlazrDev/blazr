...
namespace Blazr {
	...
	static bool showBoxColliderComponent = false;
	static bool showRigidBodyComponent = false;
	...
	void Editor::renderAnimationComponent(ImVec2& cursorPos) {
		...
		ImGui::InputInt("##numFrames", &numberOfFrames);
		//frame rate
		...
		ImGui::SameLine(ImGui::GetContentRegionAvail().x - 120);
		ImGui::PushItemWidth(130);
		ImGui::InputInt("##frameOffset", &frameOffset);
		ImGui::PopItemWidth();
		//bVertical
		ImGui::Text("bVertical");
		ImGui::SameLine(ImGui::GetContentRegionAvail().x - 10);
		ImGui::Checkbox("##bVertical", &bVertical);
	...
	void Editor::renderBoxColliderComponent(ImVec2& cursorPos) {
		...
		int widthBoxCollider = 0, heightBoxCollider = 0;
		...
		ImGui::SameLine(ImGui::GetContentRegionAvail().x - 10);
		ImGui::Checkbox("##bVertical", &isColliding);
	...
	void Editor::renderRigidBodyComponent(ImVec2& cursorPos) {

		float currentVelocityX = 0, currentVelocityY = 0, maxVelocityX = 0, maxVelocityY = 0;
		ImGui::SetCursorPos(cursorPos);
		ImGui::Separator();
		...
		cursorPos.y += 28;
		ImGui::SetCursorPos(cursorPos);
		ImGui::Text("CurrentVelocityX");
		ImGui::SameLine(ImGui::GetContentRegionAvail().x - 120);
		ImGui::PushItemWidth(130);
		ImGui::InputFloat("##currentVelocityX", &currentVelocityX, 0.1f, 1.0f, "%.1f");

		ImGui::Text("CurrentVelocityY");
		ImGui::SameLine(ImGui::GetContentRegionAvail().x - 120);
		ImGui::InputFloat("##currentVelocityY", &currentVelocityY, 0.1f, 1.0f, "%.1f");

		ImGui::Text("MaxVelocityX");
		ImGui::SameLine(ImGui::GetContentRegionAvail().x - 120);
		ImGui::InputFloat("##maxVelocityX", &maxVelocityX, 0.1f, 1.0f, "%.1f");

		ImGui::Text("MaxVelocityY");
		ImGui::SameLine(ImGui::GetContentRegionAvail().x - 120);
		ImGui::InputFloat("##maxVelocityY", &maxVelocityY, 0.1f, 1.0f, "%.1f");
		ImGui::PopItemWidth();
			...
			if (ImGui::BeginTabBar("DetailsTabs")) {
				if (ImGui::BeginTabItem("Components")) {
					if (showRigidBodyComponent) {
						renderRigidBodyComponent(cursorPos);
					}
					if (showBoxColliderComponent) {
